...
const moorelanePlaceAssets: BuiltInRichPlaceAsset[] = [
	...
	moorelaneAsset('moorelane_living_accent_armchair', 'Accent Armchair', '/ROOT/Living/Props_sitting/AccentArmChair', 'furniture', 'Furniture', [0.9, 1.0, 0.9], 'fabric', ['chair', 'living']),
	...
	moorelaneAsset('moorelane_dining_table_set', 'Dining Table Set', '/ROOT/DiningRoom/Table', 'furniture', 'Furniture', [3.0, 1.0, 1.6], 'wood', ['table', 'dining']),
	moorelaneAsset('moorelane_dining_sideboard_left', 'Left Sideboard', '/ROOT/DiningRoom/Sideboard_left', 'furniture', 'Furniture', [1.6, 0.9, 0.45], 'wood', ['sideboard']),
	moorelaneAsset('moorelane_dining_sideboard_right', 'Right Sideboard', '/ROOT/DiningRoom/Sideboard_right', 'furniture', 'Furniture', [1.6, 0.9, 0.45], 'wood', ['sideboard']),
	moorelaneAsset('moorelane_kitchen_bar_chairs', 'Bar Chair Set', '/ROOT/Kitchen/Props_kitchen/barChairs', 'furniture', 'Furniture', [1.2, 1.1, 0.6], 'wood', ['chair', 'kitchen']),
	...
	moorelaneAsset('moorelane_living_bookshelf_books', 'Bookshelf Books', '/ROOT/Living/Props_sitting/BookshelfBooks', 'object', 'Decor', [1.2, 1.2, 0.35], 'paper', ['books']),
	...
	moorelaneAsset('moorelane_living_small_lamp', 'Small Living Lamp', '/ROOT/Living/Props_sitting/Lamps', 'electronics', 'Decor', [0.35, 0.8, 0.35], 'metal', ['lamp']),
	...
	moorelaneAsset('moorelane_studio_camera', 'Studio Camera Prop', '/ROOT/Studio/Props_Cameras', 'electronics', 'Landmarks', [0.45, 0.35, 0.35], 'metal', ['studio']),
	moorelaneAsset('moorelane_studio_books', 'Studio Book Stack', '/ROOT/Studio/Props_studio/studioBooks', 'object', 'Landmarks', [0.5, 0.25, 0.35], 'paper', ['books'])
];
...
const dtcPlaceAssets: BuiltInRichPlaceAsset[] = [
	...
	dtcAsset('Marker_B08X27CJBT_Orange_TU', 'Orange Marker', 'office', 'Tools and Office', [0.16, 0.03, 0.03], 'plastic', ['marker']),
	...
	dtcAsset('AirDuster', 'Air Duster', 'object', 'Tools and Office', [0.08, 0.24, 0.08], 'metal', ['canister']),
	...
	dtcAsset('Speaker_B08H82ZRS2_Black_1', 'Black Speaker', 'electronics', 'Landmarks', [0.22, 0.16, 0.12], 'plastic', ['speaker'])
];

export const builtInRichPlaceAssets: BuiltInRichPlaceAsset[] = [...moorelanePlaceAssets, ...dtcPlaceAssets];

const groupOrder = ['Essentials', 'Furniture', 'Decor', 'Kitchen Props', 'Tools and Office', 'Landmarks'];
